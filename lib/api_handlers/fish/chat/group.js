...
module.exports = async (req, res) => {
    ...
    try {
        ...
        console.log('[AI Fish Group Chat] Requesting user ID:', requestingUserId);
        ...
        if (!requestingUserId) {
            console.warn('[AI Fish Group Chat] ⚠️ No user ID found for fish, allowing request but will not save initiator_user_id');
        } else {
